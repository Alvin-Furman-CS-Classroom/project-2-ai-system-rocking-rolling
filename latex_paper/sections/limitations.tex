...
\paragraph{Data coverage.} AcousticBrainz's 2022 archival leaves post-2022 releases and some older tracks without pre-computed features; $\sim$12\% of tracks need Essentia fallback (5--10~s overhead). Tracks absent from ListenBrainz lack graph neighbours and stall beam search; hybrid graph/content-based search would mitigate this.
