...
Module~1 takes two \texttt{TrackFeatures} objects (71-dim AcousticBrainz vectors plus metadata) and returns a \texttt{TransitionResult} of 12 scores in $[0,1]$, an overall probability, and a textual explanation. The 12 dimensions are key, tempo, energy, loudness, mood, timbre, RosaMerida genre, ListenBrainz tags, popularity, MusicBrainz artist, era, and curated MB genre.
