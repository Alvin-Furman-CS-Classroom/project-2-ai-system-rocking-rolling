...
export function Title({ isActive, replayKey }: SlideProps) {
  return (
      ...
      <div style={{
        ...
        <h1
          ...
          style={{
            ...
            fontSize: 96, fontWeight: 'bold', color: '#1a1a1a',
        ...
        <p
          ...
          style={{
            ...
            fontSize: 32, fontStyle: 'italic', color: '#e8590c',
      ...
      {isActive && createPortal(
        <div className="waveform-portal">
          <Suspense fallback={null}>
            <P5Canvas sketch={waveformSketch} isActive={isActive} replayKey={replayKey} />
          </Suspense>
        </div>,
        document.body,
      )}
